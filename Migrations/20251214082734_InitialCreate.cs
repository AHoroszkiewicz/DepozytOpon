        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OponaId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Depozyt", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rozmiar = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Bieznik = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Sezon = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RokProdukcji = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KodTowaru = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
